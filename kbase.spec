...
binaries = []
hiddenimports = ['kb.utils_yaml', 'kb.storage', 'kb.database', 'kb.app_config', 'kb.workspace', 'kb.cli', 'kb.engines._paths', 'kb.llm_config', 'kb.document_info', 'kb.translate', 'kb.calibrate', 'kb.library_chat', 'kb.engines', 'kb.engines.marker', 'kb.engines.docmind', 'kb.engines.docparser', 'kb.engines.vision_ocr', 'kb.engines.ocr', 'kb.engines.llm_vision', 'kb.engines.unisound_parser', 'kb.serve', 'kb.version', 'kb.updater', 'webview', 'fitz', 'clr']
